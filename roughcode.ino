...
int wheelSpeed = 1500;
int servo1PPos, servo2PPos, servo3PPos, servo4PPos, servo5PPos, servo6PPos; // Position to be updated
...
void loop() {
  ...
  rcCH5 = readChannel(4, 0, 270, 0);//servo2,servo 6
  rcCH6 = readSwitch(5, 0, 270, 0);
